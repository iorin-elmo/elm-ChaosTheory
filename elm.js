...
var $author$project$Main$f2s = $elm$core$String$fromFloat;
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		...
		subscriptions: function (_v1) {
			return A2($elm$time$Time$every, 1000 / $author$project$Main$tickSpeed, $author$project$Main$Tick);
		},
		update: F2(
			function (msg, model) {
				return _Utils_Tuple2(
